...
public:
    InputTestObject(Rectangle const relative,
        ...
        : UIElement{ relative, alignment },
          check_function{ check_function_ } { }

    using UIElement::UIElement;

    [[nodiscard]] bool handle_input(uil::UpdateContext const& context) override {
...
private:
    ...
    static constexpr float x(Rectangle const rectangle, Vector2 const spacer, int const columns) {
        return rectangle.x + static_cast<float>(columns) * spacer.x + static_cast<float>(columns) * rectangle.width;
    }

    static constexpr float y(Rectangle const rectangle, Vector2 const spacer, int const rows) {
        return rectangle.y + static_cast<float>(rows) * spacer.y + static_cast<float>(rows) * rectangle.height;
    }

    std::vector<Entry> const m_entries_variadic{
        // is_down
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
            y(rectangle_mouse_input, spacer_mouse_input, 0),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_down(s_key_1, s_key_2, s_mod_1, s_mod_2); }    },
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
        ...
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
         ...
         []() -> bool {
              return uil::AppContext::instance().input().is_down<uil::KeyOp::Or, uil::ModOp::And>(
                      s_key_1, s_key_2, s_mod_1, s_mod_2);
          }                                                                                                          },
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
        ...
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
            ...
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_down(s_key_1, s_key_2); }                      },
        { { x(rectangle_mouse_input, spacer_mouse_input, 0),
            y(rectangle_mouse_input, spacer_mouse_input, 5),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_down<uil::KeyOp::And>(s_key_1, s_key_2); }     },

        // is_up
        { { x(rectangle_mouse_input, spacer_mouse_input, 1),
            y(rectangle_mouse_input, spacer_mouse_input, 0),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_up(s_key_1, s_key_2, s_mod_1, s_mod_2); }      },
        { { x(rectangle_mouse_input, spacer_mouse_input, 1),
            y(rectangle_mouse_input, spacer_mouse_input, 1),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
        ...
        { { x(rectangle_mouse_input, spacer_mouse_input, 1),
            ...
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_up(s_key_1, s_key_2); }                        },
        { { x(rectangle_mouse_input, spacer_mouse_input, 1),
            y(rectangle_mouse_input, spacer_mouse_input, 5),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_up<uil::KeyOp::And>(s_key_1, s_key_2); }       },

        // is_pressed
        { { x(rectangle_mouse_input, spacer_mouse_input, 2),
            y(rectangle_mouse_input, spacer_mouse_input, 0),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_pressed(s_key_1, s_key_2, s_mod_1, s_mod_2); } },
        { { x(rectangle_mouse_input, spacer_mouse_input, 2),
            y(rectangle_mouse_input, spacer_mouse_input, 1),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
        ...
        { { x(rectangle_mouse_input, spacer_mouse_input, 2),
            ...
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_pressed(s_key_1, s_key_2); }                   },
        { { x(rectangle_mouse_input, spacer_mouse_input, 2),
            y(rectangle_mouse_input, spacer_mouse_input, 5),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_pressed<uil::KeyOp::And>(s_key_1, s_key_2); }  },

        // is_released
        { { x(rectangle_mouse_input, spacer_mouse_input, 3),
            y(rectangle_mouse_input, spacer_mouse_input, 0),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool {
        ...
        { { x(rectangle_mouse_input, spacer_mouse_input, 3),
            ...
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_released(s_key_1, s_key_2); }                  },
        { { x(rectangle_mouse_input, spacer_mouse_input, 3),
            y(rectangle_mouse_input, spacer_mouse_input, 5),
            rectangle_mouse_input.width,
            rectangle_mouse_input.height },
         []() -> bool { return uil::AppContext::instance().input().is_released<uil::KeyOp::And>(s_key_1, s_key_2); } },
    };
